class spi_to_memory_repeat_test extends spi_to_memory_base_test;

    `uvm_component_utils(spi_to_memory_repeat_test)

  


    function new(string name = "spi_to_memory_repeat_test", uvm_component parent = null);          
	...
	repeat(10) begin
        	...
        	`uvm_info("TEST", "End-to-End acquisition test completed", UVM_LOW)
