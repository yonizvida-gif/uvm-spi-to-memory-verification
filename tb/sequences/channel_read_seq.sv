class channel_read_seq extends uvm_sequence #(reg_tran);
    ...
    task body();
        ...
        for(int i = 0; i < 4; i++) begin
            ...
            tr = reg_tran::type_id::create(
                    $sformatf("read_channel_%0d", i)
                 );
            ...
            if(!tr.randomize() with {
                ...
                `uvm_error("CHANNEL_READ_SEQ",
                           "Channel READ randomization failed")
            ...
            `uvm_info("CHANNEL_READ_SEQ",
                $sformatf(
                    "Channel %0d READ: data = 0x%0h",
                    i,
                    rsp.data
                ),
                UVM_LOW)
